...
FindCubeWithDistance::FindCubeWithDistance(Storage* storage, Camera* camera, DriveBase* drive, Sensors* sensor,CommandHandler* cmd_h, int position, double distanceToWall)
{
    m_camera = camera;
    m_storage = storage;
    m_drive = drive;
    ...
    AddCommands(
            ...
            FollowWall(m_drive,m_sensor,m_cmd_h,true,m_distanceToWall,constant::Sensor_IDs::IR_R,false,150), //250,0
            ...
            DriveUntilWall(m_drive,m_sensor,m_cmd_h,0,70,0,constant::Sensor_IDs::IR_R,m_distanceToWall),
            ...
            FindCubeOben(m_storage,m_sensor,m_drive,m_camera,m_cmd_h,false,m_position,m_distanceToWall)
