...
FindCube::FindCube(Storage* store, Sensors* sensor, DriveBase* drive, Camera* camera,CommandHandler* cmd_h, bool search_right, int position, double distanceToCube)
{
    m_storage = store;
    m_drive = drive;
    m_sensors = sensor;
    ...
    AddCommands(
            ...
            SetElevator(m_storage,m_cmd_h,3781-400), //400

            frc2::WaitCommand(0.2_s),

            SetGreifarm(m_storage,m_cmd_h,148), //149
            ...
            frc2::ConditionalCommand(
                GrabCube(m_storage,m_camera,m_drive,m_sensors,m_cmd_h,m_position,false,distanceToCube), // wenn richtige Farbe erkannt wurde soll der Würfel aufgehoben werden
